...
data_ouro_tratado = tratar_arquivo_csv('./data/DESAFIO - Ouro Futuros Dados Históricos.csv')
data_petroleo_tratado = tratar_arquivo_csv('./data/DESAFIO - Petróleo WTI Futuros Dados Históricos.csv')
